package org.axisgroupservice.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "org.axisgroupservice.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "org.axisgroupservice.springboot.model" });
	    ...
	    public WebMvcConfigurer corsConfigurer() {
	        return new WebMvcConfigurerAdapter() {
	            ...
	            public void addCorsMappings(CorsRegistry registry) {
	                registry.addMapping("/channelmaster").allowedOrigins("http://localhost:8081/popadvertising-jpa");
	            }
	        };
}
